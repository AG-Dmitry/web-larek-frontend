...
export const templates = {
	cardMainTemplate: document.querySelector(
		'#card-catalog'
	) as HTMLTemplateElement,
	cardFullTemplate: document.querySelector(
		'#card-preview'
	) as HTMLTemplateElement,
	cardBasketTemplate: document.querySelector(
		'#card-basket'
	) as HTMLTemplateElement,
	formOrderTemplate: document.querySelector(
    '#order'
  ) as HTMLTemplateElement,
	formContactsTemplate: document.querySelector(
		'#contacts'
	) as HTMLTemplateElement,
};
